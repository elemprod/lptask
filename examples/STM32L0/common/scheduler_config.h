...
#include "stm32l0xx_hal.h"
  ...
  * event que.  The macro disables global interrupts when entering a critical
  * region of code which requires exclusive write accesss to the scheduler's
  * linked list event que.
  */
