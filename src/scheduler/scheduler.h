 ...
 *  
 * This different from the operation of buffered task which copies and stores 
 * the user data to its internal buffer.
 *
 * Note that the data referenced by an unbuffered task must still be valid 
 * when the task handler is called at later point in time.
 *
 ...
 * @retval The data size value stored in the task and passed to the task
 *         handler for an for an unbuffered task.  
