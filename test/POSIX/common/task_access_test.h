 ...
 * compared against the intended behaviour.
 * 
 * A copy of the task is made and the tests are performed on the copy
 * to avoid any risk of corrupting the orginal task.
 */
